...
const Codepen = React.createClass({
  ...
  render () {
    let preview = (this.props.preview) ? "preview/" : "";
    const src  = `//codepen.io/${this.props.user}/embed/${preview}${this.props.hash}/?height=${this.props.height}&theme-id=${this.props.theme}&default-tab=${this.props.tab}`;
